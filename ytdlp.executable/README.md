...
**YTDLP-Executable** is a NuGet package that includes the latest version of `yt-dlp.exe` (v2026.01.29). It is designed to complement the **YTDLP-Wrapper** library and **Ytdlp.NET** library or any other application that requires the `yt-dlp` executable for powerful media downloading capabilities.  

## Features  
- **Latest Version**: Always ships with the latest version of `yt-dlp.exe` (current version: **v2026.01.29**).  
