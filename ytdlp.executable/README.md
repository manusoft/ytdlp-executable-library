...
**YTDLP-Executable** is a NuGet package that includes the latest version of `yt-dlp.exe` (v2025.05.22). It is designed to complement the **YTDLP-Wrapper** library or any other application that requires the `yt-dlp` executable for powerful media downloading capabilities.  
